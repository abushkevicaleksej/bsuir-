from view.fig_view.workspace import Workspace
import tkinter as tk
from tkinter import ttk
from model.fig_model.point import Point
from model.fig_model.shape import Shape
import numpy as np

class FigureAppWindow(ttk.Frame):
    ...
    def create_menu_widgets(self):
        ...
        self.open_button = tk.Button(self.point_frame, text="Open file", command = self.open_file)
